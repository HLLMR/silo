<script lang="ts">
  ...
  // (Sharing curated mod sets as a link lives in Collections, a separate panel.)
...
<div class="mp">
  ...
  <p class="caveat">
    Want to share a curated set of mods (not just match a session)? Use
    <b>Collections</b> in the toolbar.
  </p>
